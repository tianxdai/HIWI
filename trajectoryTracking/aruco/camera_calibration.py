...
# ######### camera calibration ##########
# # Settings
# imagesFolder = "trajectoryTracking/aruco/images/camera_calibation/"
# videoFile = "trajectoryTracking/arucovideos/camera_calibration.mp4"
# aruco_dict = aruco.Dictionary_get(aruco.DICT_6X6_250)
# board = aruco.CharucoBoard_create(3, 3, 1, 0.8, aruco_dict)
# # video to images
...
# np.savetxt("trajectoryTracking/arucocam_calib_mtx.csv", mtx)
# np.savetxt("trajectoryTracking/arucocam_calib_dist.csv", dist)
# ######################################
...
# # setting
# imagesFolder = "trajectoryTracking/aruco/images/camera_calibation/"
# mtx = np.loadtxt("trajectoryTracking/arucocam_calib_mtx.csv")
# dist = np.loadtxt("trajectoryTracking/arucocam_calib_dist.csv")
